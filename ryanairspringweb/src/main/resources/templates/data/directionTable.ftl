                ...
                success: function (data) {
                    $("#datatable").dataTable({
                        ...
                        columns: [
                            ...
                            {'data': 'departureAirportCity'},
                            {'data': 'arrivalAirportName'},
                            {'data': 'arrivalAirportCity'},
                        ]
                    })
                }
            })
...
<body>
    <div style="width: 700px; padding: 5px; border: 1px solid black; text-align: center">
        <table id="datatable">
            <thead>
                <tr>
                    <th>Departure Airport's Name</th>
                    <th>Departure Airport's City</th>
                    <th>Arrival Airport's Name</th>
                    <th>Arrival Airport's City</th>
                </tr>
            </thead>
        </table>
    </div>
